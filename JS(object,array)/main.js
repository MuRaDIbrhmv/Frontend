...
for(let i = 0; i < idArray.length;i++){
    if (idArray[i].id === 11070){
        console.log(idArray[i].shipAddress.country)
    }
}
...
for(let i = 0; i < idArray.length;i++){
    if (idArray[i].shipAddress.country === "Germany"){
...
for(let i = 0; i < idArray.length;i++){
    if (idArray[i].id === 11065){
        console.log(`Ship name--->${idArray[i].shipName}, Country--->${idArray[i].shipAddress.country}, City--->${idArray[i].shipAddress.city}`)
    }
}
...
for(let i = 0; i < idArray.length;i++){
    if (idArray[i].id === 10550){
        console.log(idArray[i].details.length)
    }
}
...
console.log(`Profit of ID-10310 is ${sum}`)